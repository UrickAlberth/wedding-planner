...
export const expenses = mysqlTable("expenses", {
  ...
  entryInstallments: int("entryInstallments").default(1).notNull(),
  entryStartDate: varchar("entryStartDate", { length: 10 }).notNull(),
  installments: int("installments").default(1).notNull(),
  paymentStartDate: varchar("paymentStartDate", { length: 10 }).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
